  ...
  return (
    <div className="relative w-full h-[500px] bg-background rounded-3xl shadow-2xl overflow-hidden">
      ...
      <motion.div
        ...
        className="absolute top-4 left-4 sm:top-10 sm:left-10 w-24 h-24 sm:w-32 sm:h-32 bg-accent/20 rounded-full blur-3xl z-0 pointer-events-none"
      />
      <motion.div
        animate={{
          y: [0, 20, 0],
      ...
      <button
        ...
        className="absolute left-2 sm:left-4 top-1/2 -translate-y-1/2 z-20 p-2 bg-background/80 backdrop-blur-sm rounded-full shadow-lg hover:bg-background transition-all hover:scale-110"
      ...
      <button
        onClick={goToNext}
        className="absolute right-2 sm:right-4 top-1/2 -translate-y-1/2 z-20 p-2 bg-background/80 backdrop-blur-sm rounded-full shadow-lg hover:bg-background transition-all hover:scale-110"
          ...
          <button
            ...
            className={`h-2 rounded-full transition-all ${
              index === currentIndex
                ...
                : 'bg-accent/50 hover:bg-accent/80 w-2'
            }`}
...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen w-full max-w-full overflow-x-hidden bg-background">
      {/* Navigation Bar */}
      <nav className="fixed top-0 left-0 right-0 z-50 bg-background/90 backdrop-blur-md border-b border-accent/20 w-full max-w-full overflow-x-hidden">
          ...
          <div className="flex justify-between items-center h-16">
            ...
            >
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.97 }}
                className="p-2 rounded-lg text-text-main hover:bg-accent/20 transition-colors"
              ...
              <button
                ...
                className="px-4 py-2 font-body text-text-main hover:text-accent dark:hover:text-accent-light font-medium transition-colors"
              >
                Sign In
              </button>
              <motion.button
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <motion.div variants={itemVariants} className="space-y-4">
                ...
                <h1 className="text-5xl md:text-6xl lg:text-7xl font-heading font-bold text-text-main leading-tight">
                  Your journey to{' '}
              ...
              >
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm font-body text-text-secondary">Completely Anonymous</span>
                </div>
                <div className="flex items-center space-x-2">
                  <CheckCircle className="w-5 h-5 text-success dark:text-success" />
                  <span className="text-sm font-body text-text-secondary">End-to-End Encrypted</span>
                </div>
                <div className="flex items-center space-x-2">
                  <CheckCircle className="w-5 h-5 text-success dark:text-success" />
                  <span className="text-sm font-body text-text-secondary">Available 24/7</span>
                </div>
              </motion.div>
            </motion.div>
      ...
      {/* Features Section */}
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-background w-full max-w-full overflow-x-hidden">
        <div className="w-full max-w-screen-xl mx-auto">
          <motion.div
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 w-full max-w-full">
            {testimonials.map((testimonial, index) => (
              ...
              >
                ...
                <p className="text-lg font-body text-text-main mb-6 leading-relaxed italic">
                  "{testimonial.text}"
                </p>
                <div className="flex items-center space-x-2">
      ...
      {/* CTA Section */}
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-accent w-full max-w-full overflow-x-hidden">
      ...
      {/* Footer */}
      <footer className="bg-background text-text-main py-12 px-4 sm:px-6 lg:px-8 w-full max-w-full overflow-x-hidden">
        <div className="w-full max-w-screen-xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 lg:gap-8 w-full max-w-full">
            <div>
              <div className="flex items-center space-x-3 mb-4">
                ...
                <span className="text-xl font-heading font-semibold text-text-main">Nchekwa_Afrika</span>
              </div>
              <p className="text-sm font-body text-text-main/70">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm font-body">
                <li><a href="#" className="hover:text-accent-light transition-colors">Helplines</a></li>
                <li><a href="#" className="hover:text-accent-light transition-colors">Shelters</a></li>
                <li><a href="#" className="hover:text-accent-light transition-colors">Legal Aid</a></li>
              </ul>
            </div>
            <div>
              <h4 className="font-heading font-semibold text-text-main mb-4">Support</h4>
              <ul className="space-y-2 text-sm font-body">
                <li><a href="#" className="hover:text-accent-light transition-colors">Chat</a></li>
                <li><a href="#" className="hover:text-accent-light transition-colors">Safety Plan</a></li>
                <li><a href="#" className="hover:text-accent-light transition-colors">Education</a></li>
              </ul>
            </div>
            <div>
              <h4 className="font-heading font-semibold text-text-main mb-4">Privacy</h4>
              <ul className="space-y-2 text-sm font-body">
                ...
                <li><a href="#" className="hover:text-accent-light transition-colors">Quick Exit</a></li>
              </ul>
            </div>
          </div>
          <div className="mt-8 pt-8 border-t border-primary/20 text-center text-sm font-body text-text-main/70">
