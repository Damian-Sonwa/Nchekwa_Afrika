  ...
  return (
    <div className="w-full max-w-full overflow-x-hidden box-border space-y-6 pb-20 md:pb-8">
      ...
      <div className="flex items-center space-x-4 mb-6">
        ...
        <div>
          <h1 className="text-3xl font-heading font-bold text-text-main dark:text-white mb-2">Legal & Advocacy</h1>
          <p className="text-lg font-body text-text-secondary leading-relaxed dark:text-white/80">Legal resources and support tools</p>
        </div>
      </div>
